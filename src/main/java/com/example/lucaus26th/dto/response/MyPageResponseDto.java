...
public class MyPageResponseDto {
    ...
    public static MyPageResponseDto fromEntity(Member member,int boothLikeCount,List<BoothResponseDto.MyBooth> boothLikeList){ //나중에 푸드도
        return MyPageResponseDto.builder()
                .name(member.getName())
                .likeCount(boothLikeCount) // 여기에 푸드트럭 리스트 사이즈도 더하기
